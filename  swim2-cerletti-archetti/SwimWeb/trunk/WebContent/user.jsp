		...
		<div id="swimContent" class="topWidthElement">
			<div id="profileHeader">
				<div class="imageContainer">
					<img src="<%=request.getContextPath()%>/resources/big-user-img.png" class="profileImg" />
				</div>
				<div class="username  headerElem">Dario Archetti</div>
				<div class="userControls headerElem">
					<form>
						<input type="submit" value="Richiesta di amicizia"
							class="inputsubmit" />
					</form>
				</div>
				<div class="userControls headerElem">
					<form>
						<input type="submit" value="Richiesta di lavoro"
							class="inputsubmit" />
					</form>
				</div>
			</div>
