	...
	<div id="swimContentContainer">
		<div id="swimContent" class="topWidthElement">
			<form id="searchForm"
				...
				<div class="inputLine">
					<label class="inputLabel" for="surname">Cognome</label> 
					<input type="text" id="surname" name="surname" class="inputtext" />
				</div>
				<div class="inputLine">
					<label class="inputLabel" for="location">Luogo</label> 
				...
				<div class="inputLine">
					<label class="inputLabel" for="filter">Filtra la ricerca tra gli amici</label>
