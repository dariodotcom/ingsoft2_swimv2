		...
		<div id="swimContent" class="topWidthElement">
			...
			<div id="pageContent" class="monoPageContent">
				...
				<p class="paragraph">
					...
					attivita'. Recentemente i suoi affari stanno andando alla grande e
					la sua azienda ha bisogno di ingrandirsi. Ecco che Laura butta giu'
					una lista di cose da fare: fondamentalmente quello che le occorre
					e' un'agenzia pubblicitaria e qualcuno che finanzi la sua impresa.
					Un amico di Laura, membro di SWIM, le suggerisce di usare le
					connessioni su SWIM per entrare in contatto con le persone giuste,
					risparmiando tempo, energie e trovando i professionisti piu'
					qualificati. Laura scopre che SWIM non e' soltanto una rete di
					connessioni, ma un gruppo di persone reali pronte a raggiungere i
					suoi obiettivi. Dopo soltanto pochi giorni Laura riceve dai suoi
					contatti una lista di agenzie pubblicitarie che, secondo le loro
					esperienze dirette, sono le migliori per il suo specifico settore.
					Una volta risolto con l'agenzia pubblicitaria a Laura non resta che
					trovare dei finanziamenti per la sua impresa. Non sapendo da dove
					iniziare, ma ricordando le parole del suo amico, Laura inizia una
					ricerca avanzata su SWIM cercando persone disposte ad investire nel
					suo specifico settore. Chiede quindi ai suoi contatti diretti di
					essere presentata a queste persone. Finalmente Laura ha la
					possibilita' di presentare il suo progetto a questi investitori.
					Per la prima volta Laura guarda SWIM in un modo diverso: SWIM non
					e' piu' solo una rete di connessioni, ma uno strumento
					importantissimo che le ha permesso di entrare in contatto con le
					persone giuste e raggiungere i suoi obiettivi.<br /> Questa e' la
