...
public enum ErrorType {
	...
	BAD_REQUEST(
			"Bad Request",
			"C'Ë un errore nella tua richiesta. Se hai digitato l'url controlla di non aver fatto errori."),
	INVALID_REQUEST(
			"Richiesta non valida",
			"Non Ë possibile portare a termine la richiesta effettuata perchË non Ë valida."),
	...
	LOGIN_REQUIRED(
			"Login Required",
			"Non puoi accedere alla funzionalit‡ che hai richiesto perchË essa Ë disponibile solo per gli utenti registrati."
			),
	BAD_EMAIL(
			"Email non valida",
			"L'indirizzo email inserito non Ë valido."
			),
	INCORRECT_PASSWORD(
			"Password non corretta",
			"La password corrente inserita non Ë corretta."
			),
	INVALID_PASSWORD(
			"Password non valida",
			"La nuova password inserita inserita non Ë valida."
			),
	EMAIL_NOT_AVAILABLE(
			"Email non libera",
			"L'indirizzo email inserito Ë gi‡ in uso."
			),
	EMPTY_FIELDS(
			"Empty Fields",
	...
	USERNAME_NOT_AVAILABLE(
			...
			"Lo username che hai scelto non Ë disponibile."
			),
	INVALID_CREDENTIALS(
