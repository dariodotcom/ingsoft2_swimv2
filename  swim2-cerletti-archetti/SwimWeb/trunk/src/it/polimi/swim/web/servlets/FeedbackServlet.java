...
public class FeedbackServlet extends SwimServlet {
	...
	private void showReceivedFeedbackList(HttpServletRequest req, HttpServletResponse resp)
			throws IOException {
	...
	private void showSentFeedbackList(HttpServletRequest req, HttpServletResponse resp)
			throws IOException {
		PrintWriter w = resp.getWriter();
		resp.setContentType("text/html");
